...
// PD-14 ENS Address Lookup
async function getENSAddress() {
  const ENS_name = "ormr.eth";
  var ENS_address = await web3.eth.ens.getAddress(ENS_name);
  document.getElementById('ENSAddress').innerText = ENS_address;
}
